...
INSERT INTO business
  ...
  VALUES
    ...
    ('Bad image <img src="https://url.to.file.which/does-not.exist" onerror="alert(document.cookie);">. But not <strong>all</strong> bad.','Desktop97!'),
    ('To Be Updated Inc','password'),
    ('To Be Deleted LLC','Desktop97!');
